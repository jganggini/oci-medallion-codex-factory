...
def main() -> int:
    ...
    parser.add_argument("--command", required=True, choices=("create-application", "run-application"))
    ...
    if args.command == "create-application":
        ...
        print(json.dumps({"status": "ok", "command": args.command, "archive_path": str(archive)}, indent=2, ensure_ascii=True))
        return 0
