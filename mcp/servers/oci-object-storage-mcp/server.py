...
def main() -> int:
    ...
    parser.add_argument("--command", required=True, choices=("create-bucket", "upload-object", "sync-bucket-manifest"))
    ...
    if args.runtime == "oci":
        if args.command in ("create-bucket", "sync-bucket-manifest"):
